...
from appointment_service.slices.confirm_appointment.api import router as confirm_router
...
from appointment_service.slices.reject_appointment.api import router as reject_router
